...
PHP_INI_ENTRY1("openrasp.initial_retry_interval", "200", PHP_INI_SYSTEM, OnUpdateOpenraspIntGEZero, &openrasp_ini.initial_retry_interval)
PHP_INI_ENTRY1("openrasp.max_retry_interval", "7200", PHP_INI_SYSTEM, OnUpdateOpenraspIntGEZero, &openrasp_ini.max_retry_interval)
PHP_INI_ENTRY1("openrasp.retry_interval_factor", "1.5", PHP_INI_SYSTEM, OnUpdateOpenraspDoubleGEZero, &openrasp_ini.retry_interval_factor)
