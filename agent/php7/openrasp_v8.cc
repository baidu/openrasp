...
static inline bool init_platform();
static inline bool shutdown_platform();
static inline bool init_snapshot();
static inline bool shutdown_snapshot();
static inline bool init_isolate();
static inline bool shutdown_isolate();

bool openrasp_check(v8::Isolate *isolate, v8::Local<v8::String> type, v8::Local<v8::Object> params)
{
...
unsigned char openrasp_check(const char *c_type, zval *z_params)
{
    ...
    auto params = v8::Local<v8::Object>::Cast(zval_to_v8val(z_params, isolate));

    return openrasp_check(isolate, type, params);
}
...
static inline bool init_snapshot()
{
    ...
    {
        process_globals.snapshot_blob = get_snapshot();
    }
    return true;
}
...
v8::Isolate *get_isolate()
{
    ...
    if (oam.get_plugin_update_timestamp() > process_globals.plugin_update_timestamp)
    {
            ...
            timestamp > process_globals.plugin_update_timestamp)
        {
            ...
            load_plugins();
            auto snapshot_blob = get_snapshot();
