...
#if defined(HAVE_SYS_STAT_H) || defined(HAVE_SYS_EVENT_H) || defined(HAVE_PORT_H) || defined(HAVE_SYS_INOTIFY_H)
...
#else
void empty_symbol_for_path_utils() {}
#endif /* defined(HAVE_SYS_STAT_H) || defined(HAVE_SYS_EVENT_H) || defined(HAVE_PORT_H) || defined(HAVE_SYS_INOTIFY_H) */