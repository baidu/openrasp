...
Snapshot::Snapshot(const std::string &config, const std::vector<PluginFile> &plugin_list,
                   const std::function<void(Isolate *isolate)> action_extractor) : Snapshot()
{
