    ...
    if (stream)
    {
        ...
        if (buffer)
        {
            ...
            if (isolate)
            {
                ...
                params->Set(context, openrasp::NewV8String(isolate, "name"), openrasp::NewV8String(isolate, form_data_name)).IsJust();
                params->Set(context, openrasp::NewV8String(isolate, "filename"), openrasp::NewV8String(isolate, realname_str)).IsJust();
