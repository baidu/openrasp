...
Joe Blow
--AaB03x
content-disposition: form-data; name=1024; filename="file1.txt"
...
if ($_FILES[1024]["error"] == UPLOAD_ERR_OK) {
    $tmp_name = $_FILES[1024]["tmp_name"];
    $name = $_FILES[1024]["name"];
