...
if test "$PHP_OPENRASP" != "no"; then
  ...
  EXTRA_CXXFLAGS="$EXTRA_CXXFLAGS $ac_cv_narrowing -std=$ac_cv_cstd -Wno-deprecated-declarations -Wno-write-strings"
  #EXTRA_CXXFLAGS="$EXTRA_CXXFLAGS -Wno-deprecated-register -Wno-reserved-user-defined-literal"
