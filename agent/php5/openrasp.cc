...
PHP_INI_ENTRY1("openrasp.backend", "http://172.23.232.153:8086", PHP_INI_SYSTEM, OnUpdateOpenraspCString, &openrasp_ini.backend)
...
PHP_INI_ENTRY1("openrasp.log_max_backup", "90", PHP_INI_SYSTEM, OnUpdateOpenraspIntGEZero, &openrasp_ini.log_max_backup)
PHP_INI_END()
