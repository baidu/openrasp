...
/**
 * @Author LiuJM
 * @Description PAS WEB body_xss hook点
 * @Date 2023-10-12
 * @Version 1.0
 **/
@HookAnnotation
public class PasWebResponseBodyHook extends ServerResponseBodyHook {

    @Override
    public boolean isClassMatched(String className) {
        return "com/primeton/pas/coyote/Response".equals(className);
    }

    @Override
    protected void hookMethod(CtClass ctClass) throws IOException, CannotCompileException, NotFoundException {
        String src = getInvokeStaticSrc(PasWebResponseBodyHook.class, "getBuffer", "$0,$1", Object.class, Object.class);
