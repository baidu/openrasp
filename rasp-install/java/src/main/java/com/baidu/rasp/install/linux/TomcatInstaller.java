...
public class TomcatInstaller extends BaseStandardInstaller {
    ...
    private static String JAVA_AGENT_CONFIG = "\tJAVA_OPTS=\"-javaagent:${CATALINA_HOME}/rasp/rasp.jar -XX:OnError=\\\"bash ${CATALINA_HOME}/rasp/crash.sh\\\" ${JAVA_OPTS}\"\n";
    private static String PREPEND_JAVA_AGENT_CONFIG = "\tJAVA_OPTS=\"${JAVA_OPTS} -javaagent:${CATALINA_HOME}/rasp/rasp.jar -XX:OnError=\\\"bash ${CATALINA_HOME}/rasp/crash.sh\\\" \"\n";
