...
public class RaspError extends Exception {
    ...
    public static String E10006 = "[ERROR 10006] Failed to attach OpenRASP javaagent: ";
    public static String E10007 = "[ERROR 10007] Unsupported application server type: ";
